...
const BarExchangeIn = ({ formData, handleTextChange, handleAccoTranID, handleBEPGTypeChange, handleBEPGSubTypeChange, handleBEPGPure, handleBEPGPremium, handleBEPGCount, handleBEPGCaluculations, handleInventoryItemAdd, readOnly }) => {
